  ...
  return (
    <Div bg="warning" p="25px" align="center">
      <Text fontSize={{ xs: '1.3em', sm: '1.5em' }} m="0 0 10px">
        {dmoka
          ? t('announce.dmoka', 'Possibilité de sessions de D.M.O.K.A. en ligne sur Skype !')
          : t('announce.default', 'Possibilité de sessions en ligne sur Skype !')}
      </Text>
      <br />
      <a href="https://www.facebook.com/story.php?story_fbid=232759478113047&id=104513137604349" target="_blank" style={{ textDecoration: 'none' }}>
        <Text italic color="black">
          {t('announce.moreInfo', "Plus d'informations ici")}
        </Text>
      </a>
    </Div>
  );
