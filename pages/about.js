...
const AboutPage = () => (
  <Layout>
      ...
      <Cell w={{ xs: 1, sm: 1 / 2, md: 2 / 3 }}>
        <Div p="50px">
          ...
          <P>
            ...
            les outils que j'utilise aujourd’hui dans ma pratique et qui m'ont accompagné sur ce chemin – en particulier
            Gilles Placet et Pascale Chavance. C'est aussi grâce à eux si aujourd’hui je suis la psychologue que je
            suis.
          </P>
          <P>
            Depuis sept ans, j’accompagne mes patients, hommes et femmes courageux, qui ont décidés d’aller au-delà
            d’une vision superficielle d’eux-mêmes et d’embrasser leurs souffrances. En découvrant le sens supérieur de
            nos expériences, on s’allège petit à petit, et le chemin devient plus joyeux et libre des conditionnements
          ...
          <P>
            ...
            nous-même, avec cette part de sagesse qui nous accompagne depuis toujours, même si nous n’avons pas toujours
            été à son écoute. C’est grâce à elle que nous pouvons reconquérir un espace de liberté intérieur et
            retrouver la voie qui nous est propre.
          </P>
        </Div>
      </Cell>
    </Row>
    ...
    <Row>
      <Cell w={{ xs: 1, sm: 1 / 2, md: 2 / 3 }}>
        <Div p="50px">
          ...
          <P>
            ...
            l’interaction avec les systèmes auquel nous appartenons – en particulier notre famille. Ce dernier point est
            ce qui caractérise l’approche systémique.
          </P>
          <P>
            La personne qui demande de l’aide parce qu’elle vit une souffrance, est en effet souvent porteuse d’une
            problématique plus profonde du système auquel elle appartient. Elle porte la lumière sur un déséquilibre
            qui, grâce au travail sur soi, peut être dépassé, ainsi que le formule A. Jodorowsky :{' '}
            <em>
              « Les souffrances familiales, comme les anneaux d'une chaîne, se répètent de génération en génération
              jusqu'à ce qu'un descendant (...) en prenne conscience et transforme sa malédiction en bénédiction. »
            </em>
          </P>
          <P>
            La vision systémique permet d’élargir le regard à tout le système auquel nous appartenons – en dernière
            instance, la société – en mettant en lumière les mécanismes et inégalités qui bloquent notre pleine
            réalisation dans notre singularité, authenticité et liberté de conscience. La célèbre citation de
            Krishnamurti,{' '}
            <em>« ce n’est pas un signe de bonne santé mentale que d’être bien adapté à une société malade »</em>,
            reflète le piège dans lequel on tombe quand on cherche à « normaliser » la souffrance. On empêche alors que
            la crise devienne un moteur de changement au niveau personnel et sociétal.
          </P>
          <P>
            En tant que psychologue, j’espère contribuer à la création d’une société plus juste, en permettant à ceux
            qui viennent me voir d’initier ou d’approfondir un travail intérieur. Comme le dit le philosophe et paysan
            Pierre Rabhi,{' '}
            <em>
      ...
      <Cell w={{ xs: 1, sm: 1 / 2, md: 1 / 3 }}>
        <Div p="50px 50px 50px 0">
          <Image src="/static/images/colibris.jpg" />
        </Div>
      </Cell>
    </Row>
    <FooterSection />
