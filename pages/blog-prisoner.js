  ...
  return (
    <Layout>
      <Head>
        <title>
          {t(
            'blog-prisoner.headTitle',
            "Je me sens prisonnier ! Souvenirs de confinement - Blog d'Anna Elisa Valmori, psychologue"
          )}
        </title>
      </Head>
      <TopSection image="prisoner-small.jpg" subTitle={t('blog-prisoner.subTitle', 'Souvenirs de confinement')}>
        {t('blog-prisoner.title', 'Je me sens prisonnier !')}
      </TopSection>
      <ArticleSection>
        <LeadP>
          {t(
            'blog-prisoner.lead.p1',
          ...
          <br/>
          <strong>
            {t('blog-prisoner.lead.p2', 'Que pouvons-nous apprendre pour en sortir plus conscients et plus forts ?')}
          </strong>
        </LeadP>
        <P>
          {t(
            'blog-prisoner.body.p1',
        ...
        <H size={2}>
          {t('blog-prisoner.heading.stop', 'Que faire lorsque nous sommes « contraints » de nous arrêter ?')}
        </H>
        <P>
          {t(
            'blog-prisoner.body.p4',
        ...
        <H size={2}>
          {t('blog-prisoner.heading.externalReality', 'La réalité extérieure est-elle la cause de nos émotions ?')}
        </H>
        <P>
          {t(
            'blog-prisoner.body.p6',
        ...
        <H size={2}>
          ...
          {t('blog-prisoner.heading.change', 'Traverser le changement et lâcher prise')}
        </H>
        <P>
          {t(
            'blog-prisoner.body.p10',
        ...
        <H size={2}>{t('blog-prisoner.heading.priorities', 'Nos priorités changent')}</H>
        <P>
          {t(
            'blog-prisoner.body.p13',
        ...
        <H size={2}>{t('blog-prisoner.heading.prisoner', '« Je me sens prisonnier ! »')}</H>
        <P>
          {t(
            'blog-prisoner.body.p16',
        ...
        <H size={2}>
          ...
          {t('blog-prisoner.heading.direction', 'Quelle direction pouvons-nous choisir ?')}
        </H>
        <P>
          {t(
            'blog-prisoner.body.p19.before',
            "Et si nous reconstruisions dès aujourd'hui les fondations pour nous reconnecter à notre "
          )}
          <PageLink page="blog-inner-child">
            {t('blog-prisoner.body.p19.linkLabel', 'enfant intérieur')}
          </PageLink>
          {t(
            'blog-prisoner.body.p19.after',
            ', à notre vrai Soi, dans sa totalité ? Et si nous renforçions le lien avec notre Âme, qui sait ce qui est important ' +
              'et essentiel ?'
          )}
        </P>
        <P>
          {t(
            'blog-prisoner.body.p20',
        ...
        <P>{t('blog-prisoner.body.p21', "Il n'est jamais trop tard.")}</P>
        <H size={2}>{t('blog-prisoner.heading.conclusion', 'En conclusion')}</H>
        <P>
          {t(
            'blog-prisoner.body.p22',
        ...
        <P>
          {t(
            'blog-prisoner.body.p27',
            'Parce que la liberté la plus importante est la liberté intérieure et que personne ne pourra jamais vous ' +
              "l'enlever."
          )}
        </P>
        <P>
          {t('blog-prisoner.body.signature.a', 'Je vous embrasse.')}
          <br />
          {t('blog-prisoner.body.signature.b', 'Anna Elisa')}
        </P>
      </ArticleSection>
      <FooterSection/>
    </Layout>
